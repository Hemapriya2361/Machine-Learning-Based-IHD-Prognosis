export const COLORS = {
  // Risk classification (kept for medical meaning)
  hr:   "#C0392B",          // High-risk red
  lr:   "#2980B9",          // Low-risk blue
  neu:  "#6B7280",          // Neutral slate
  gold: "#D97706",          // Moderate-risk amber (darkened for beige bg contrast)
  green:"#16A34A",          // Positive green

  // Light/Beige UI palette
  bg:          "#FAF9F6",   // Minimalist Off-White background
  bgAlt:       "#F5F5DC",   // Sophisticated Beige (sidebar, panels)
  surface:     "#FFFFFF",   // Card / container surfaces
  surfaceSub:  "#F8F7F4",   // Subtle nested surface
  border:      "#E8E4DC",   // Soft warm border
  borderStrong:"#D4CFC5",   // Slightly stronger border

  // Text
  textPrimary:  "#1C1C1E",  // Near-black for headings
  textSecondary:"#4B5563",  // Dark slate for body
  textMuted:    "#9CA3AF",  // Muted labels

  // Controls
  btnPrimary:   "#2F3E46",  // Forest Slate — main CTA
  btnHover:     "#1F2D34",  // Darker hover state
  accent:       "#2C3E50",  // Deep Charcoal — accents / active tabs
